...
# We use the Py2 input() function. In Py3 there is no such function,
...
# 'chunk' module removed; handling manually
try:
    import readline
except:
    pass
...
class BlorbTool:
    ...
    def parse_chunk_type(self, val, label=''):
        ...
        return val.ljust(4).encode('utf-8')
    ...
    def cmd_giload(self, args):
        ...
        chunkdatenc = base64.b64encode(chunkdat).decode('utf-8')
