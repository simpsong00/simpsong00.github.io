...
[![Picture](/simpsong00-clone/images/uploads/weebly/bitcoin-mining-businessorigjpg.jpg)]()
...
There are several controls around the mining process. For example, the rate of bitcoin mining is reduced over time; it is cut in half every four years. In 2009, you received 50 bitcoin (BTC) for completing 1 block of mining. In 2020, you receive 6.25 BTC for the same work, 
Essentially, when you complete the mining process, a transaction is recorded on the bitcoin blockchain transferring newly minted bitcoin to you.

Specialized computers have been created to be faster at mining, and these computers can use a lot of electricity. With the value of bitcoin at close to $40,000, many people are willing to pay for the power to run the computers to do the mining. Companies like Stronghold Digital mining are buying entire power plants to power their bitcoin mining operations. 
As I said, there is also a limit to the total number of bitcoin that can ever be mined. B
ased on current projections, it expected that all bitcoin will be mined by the year 2140*.
...
* 
[https://www.investopedia.com/tech/what-happens-bitcoin-after-21-million-mined/#bitcoin-mining-rewards](https://www.investopedia.com/tech/what-happens-bitcoin-after-21-million-mined/#bitcoin-mining-rewards)
