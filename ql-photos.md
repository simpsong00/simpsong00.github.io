---
layout: default
title: Quantum Launch — Photo Gallery
permalink: /ql-photos/
description: "Photos from the real-world locations behind Quantum Launch, the prequel to the Quotient Series by Gregory R. Simpson. Coming 2027."
redirect_from:
  - /QL_photos.html
  - /ql_photos.html
---
...
<div class="gallery-header">
  <div class="container">
    <h1>Quantum Launch — Photo Gallery</h1>
    <p>A first look at real places behind the prequel — more to come as <em>Quantum Launch</em> nears its 2027 release.</p>
  </div>
</div>
...
<div class="container">
  <div class="page-content">
    ...
    <p>Like the rest of the Quotient Series, every location in <em>Quantum Launch</em> is a real place the author has visited. Here's an early look — check back as the collection grows. Click any photo to view it full size.</p>

    {% assign gallery = site.static_files | where_exp: "f", "f.path contains '/assets/ql-gallery/'" | sort: "path" %}
    <div class="photo-grid" id="photoGrid">
      {% for photo in gallery %}
      <a href="{{ photo.path | relative_url }}" data-index="{{ forloop.index0 }}">
        <img src="{{ photo.path | relative_url }}" alt="Quantum Launch location photo {{ forloop.index }}" loading="lazy">
      </a>
      {% endfor %}
    </div>
