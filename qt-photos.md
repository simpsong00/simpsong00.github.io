---
layout: default
title: Quantum Time — Photo Gallery
permalink: /qt-photos/
description: "Photos from the real-world locations behind Quantum Time, Book 2 of the Quotient Series by Gregory R. Simpson."
redirect_from:
  - /QT_photos.html
  - /qt_photos.html
---
...
<div class="gallery-header">
  <div class="container">
    <h1>Quantum Time — Photo Gallery</h1>
    <p>Real places behind the story — from Sydney and the Great Barrier Reef to Oxford, Israel, Africa, and beyond.</p>
  </div>
</div>
...
<div class="container">
  <div class="page-content">
    ...
    <p>Every location in <em>Quantum Time</em> is a real place the author has visited. Here's a look at some of them. Click any photo to view it full size.</p>

    {% assign gallery = site.static_files | where_exp: "f", "f.path contains '/assets/qt-gallery/'" | sort: "path" %}
    <div class="photo-grid" id="photoGrid">
      {% for photo in gallery %}
      <a href="{{ photo.path | relative_url }}" data-index="{{ forloop.index0 }}">
        <img src="{{ photo.path | relative_url }}" alt="Quantum Time location photo {{ forloop.index }}" loading="lazy">
      </a>
      {% endfor %}
    </div>
